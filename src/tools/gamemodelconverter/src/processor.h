...
public:
    enum class ResultId
    {
        ...
        // #TODO Add more detailed execution errors once GameModelFile supports it
...
private:
    ...
    static Result Add_Load_W3D_Command(CommandPtrs &commands, const FileMap &file_map, const CommandAction &action);
    static Result Add_Load_W3X_Command(CommandPtrs &commands, const FileMap &file_map, const CommandAction &action);
    static Result Add_Load_BLEND_Command(CommandPtrs &commands, const FileMap &file_map, const CommandAction &action);
    static Result Add_Load_MAX_Command(CommandPtrs &commands, const FileMap &file_map, const CommandAction &action);
    static Result Add_Save_W3D_Command(CommandPtrs &commands, const FileMap &file_map, const CommandAction &action);
    static Result Add_Save_W3X_Command(CommandPtrs &commands, const FileMap &file_map, const CommandAction &action);
    static Result Add_Save_BLEND_Command(CommandPtrs &commands, const FileMap &file_map, const CommandAction &action);
    static Result Add_Save_MAX_Command(CommandPtrs &commands, const FileMap &file_map, const CommandAction &action);
    ...
    static GameModelFilePtr Get_File_Ptr(const FileMap &file_map, FileId file_id);

    template<class Type> static const Type *Find_Ptr(const CommandArguments &arguments, size_t occurence = 0);
    static GameModelFilePtr Get_File_Ptr(const CommandArguments &arguments, const FileMap &file_map, size_t occurence = 0);
    static const char *Get_File_Path(const CommandArguments &arguments, size_t occurence = 0);
    static GameModelOptions Get_Options(const CommandArguments &arguments, size_t occurence = 0);
