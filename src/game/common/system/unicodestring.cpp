...
Utf16String::reference Utf16String::at(size_type index)
{
    return Peek()[index];
}

Utf16String::reference Utf16String::front()
{
    return Peek()[0];
}

Utf16String::reference Utf16String::back()
{
    return Peek()[Get_Length() - 1];
}

Utf16String::const_reference Utf16String::at(size_type index) const
{
    return Peek()[index];
}

Utf16String::const_reference Utf16String::front() const
{
    return Peek()[0];
}

Utf16String::const_reference Utf16String::back() const
{
    return Peek()[Get_Length() - 1];
}
...
bool Utf16String::empty() const noexcept
{
    return Is_Empty();
}

void Utf16String::reserve(size_type capacity)
{
...
void Utf16String::resize(size_type size)
{
    resize(size, value_type());
}

void Utf16String::resize(size_type size, value_type ch)
{
...
Utf16String::size_type Utf16String::length() const
{
    return Get_Length();
}
